<head>
  ...
  <title>@yield('judul_halaman') - Sistem Rekam Medis</title>
  ...
  <link href="{{ URL::asset('css/tempusdominus-bootstrap-4.css') }}" rel="stylesheet">
  ...
  <script src="{{ URL::asset('js/jQuery.print.min.js') }}" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - diagnosa Collapse Menu -->
      <li class="nav-item {{ set_menu(['diagnosa', 'diagnosa.tambah', 'diagnosa.edit']) }}">
        ...
        <div id="collapseSeven" class="collapse {{ set_show(['diagnosa', 'diagnosa.tambah', 'diagnosa.edit']) }}" aria-diagnosaelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            
            <a class="collapse-item {{ set_menu('diagnosa') }}" href="{{ route('diagnosa') }}">Daftar Diagnosa</a>
            <a class="collapse-item {{ set_menu('diagnosa.tambah') }}" href="{{ route('diagnosa.tambah') }}">Tambah Diagnosa</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item {{ set_menu(['tindakan', 'tindakan.tambah', 'tindakan.edit']) }}">
        ...
        <div id="collapseSix" class="collapse {{ set_show(['tindakan', 'tindakan.tambah', 'tindakan.edit']) }}" aria-tindakanelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">            
            <a class="collapse-item {{ set_menu('tindakan') }}" href="{{ route('tindakan') }}">Daftar Tindakan</a>
            <a class="collapse-item {{ set_menu('tindakan.tambah') }}" href="{{ route('tindakan.tambah') }}">Tambah Fasilitas Tindakan</a>
          </div>
        </div>
      </li>
              <!-- Nav Item - Lab Collapse Menu -->
      ...
      <li class="nav-item {{ set_menu(['rm', 'rm.tambah', 'rm.edit','rm.list','rm.lihat','rm.tambah.id','tagihan']) }}">
        ...
        <div id="collapseFive" class="collapse {{ set_show(['rm', 'rm.tambah', 'rm.edit','rm.lihat','rm.tambah.id']) }}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item {{ set_menu(['rm.laporan']) }}" href="{{ route('rm.laporan') }}?start_date=<?php echo date("Y-m-01",); ?>&end_date=<?php echo date("Y-m-d"); ?>">Laporan</a>   
          </div>
        </div>
      </li>
      ...
      <!-- Nav Item - Charts -->
      <li class="nav-item {{ set_menu(['pengaturan', 'pengaturan.simpan']) }}">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseeleven" aria-expanded="true" aria-controls="collapsePages">
          <i class="fas fa-fw fa-sliders-h"></i>
          <span>Pengaturan</span></a>
          <div id="collapseeleven" class="collapse {{ set_show(['pengaturan', 'pengaturan.simpan', 'pengaturan.refreshdb', 'pengaturan.refreshdatabase' ]) }}" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item {{ set_menu(['pengaturan']) }}" href="{{route('pengaturan')}}">General</a>
            <a class="collapse-item {{ set_menu(['backup']) }}" href="{{route('backup')}}">Backup</a>
            @if (Auth::user()->super_admin == 1)
            <a class="collapse-item {{ set_menu(['pengaturan.logactivity']) }}" href="{{route('pengaturan.logactivity')}}">Aktivitas Pengguna</a>
            @endif
            <!-- <a class="collapse-item {{ set_menu(['pengaturan.refreshdb']) }}" href="{{route('pengaturan.refreshdb')}}">Reset Database</a> -->
          </div>
        </div>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; {{get_setting('n_Klinik')}} V1.0.1 | Development & Modify by <a href="https://amantrabali.com" target="_blank">Amantra Creative</a> | Source by Shaplinx Github</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->

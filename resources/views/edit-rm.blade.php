                              ...
                              <a href="javascript:;" onclick="addresep()" type="button" name="addresep" id="addresep" class="btn btn-success">Tambahkan</a>
                               ...
                               <div class="form-group row">
                                ...
                                <tr>
                                    ...
                                    <td><input type="hidden" name="resep[{{$i}}][jumlah_u]" value="" placeholder="Jumlah" class="form-control jumlah_a"></td>
                                    <td width="20%"><input type="text" name="resep[{{$i}}][jumlah]" value="{{$data->jum[$i]}}" placeholder="Jumlah" class="form-control jumlah_b" required></td>
...
<script type="text/javascript">
    $(document).ready(function () {
        var jum_b = $(".jumlah_b").val();
        var jum_t = jum_b - jum_b;        
        $(".jumlah_a").val(jum_t);
        $('.jumlah_b').change(function() {
          var jum_s = $(this).val() - jum_b;
          $(".jumlah_a").val(jum_s);         
        });
    });
</script>

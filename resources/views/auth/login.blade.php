              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">SISTEM REKAM MEDIS</h1>
                  </div>
...
<!--                                     <a class="btn btn-primary btn-user btn-danger btn-block" href="{{ route('password.request') }}">
         ...
         <div class="copyright text-center my-auto">
            <span>Copyright &copy; Sistem Rekam Medis {{get_setting('n_Klinik')}} V1.0.2 by <a href="https://amantrabali.com" target="_blank">Amantra Creative</a></span>
          </div>

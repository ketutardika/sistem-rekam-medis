        ...
        <div class="card-header d-sm-flex align-items-center justify-content-between py-3">               
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0" data-order='[[ 0, "desc" ]]'>
                  <thead>
                    <tr>
                      <th>#</th>
                      <th>Nama Lengkap</th>
                    ...
                    <tr>
                      ...
                      <td>                      
                        <a href ="{{ (Auth::user()->id === $user->id) ? route('profile.edit') : route('profile.edit.admin', $user->id) }}" class="btn btn-sm btn-icon-split btn-warning">
                            <span class="icon"><i class="fa fa-pen" style="padding-top: 4px;"></i></span>
                        </a>

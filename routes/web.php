...
Route::get('/pasien/cetak-pdf', 'PasienController@cetak_pdf')->name('pasien.cetakpdf')->middleware('auth');

Route::post('/pasien/print/', 'PasienController@pasien_print')->name('pasien.print')->middleware('auth');
...
Route::post('/obat/import', 'ObatController@import')->name('obat.import')->middleware('auth');

Route::get('/obat/export', 'ObatController@export')->name('obat.export')->middleware('auth');

Route::get('/obat/cetak-pdf', 'ObatController@cetak_pdf')->name('obat.cetakpdf')->middleware('auth');

Route::post('/obat/print/', 'ObatController@obat_print')->name('obat.print')->middleware('auth');
...
Route::post('/lab/import', 'LabController@import')->name('lab.import')->middleware('auth');

Route::get('/lab/export', 'LabController@export')->name('lab.export')->middleware('auth');

Route::get('/lab/cetak-pdf', 'LabController@cetak_pdf')->name('lab.cetakpdf')->middleware('auth');

Route::post('/lab/print/', 'LabController@lab_print')->name('lab.print')->middleware('auth');
...
Route::get('/diagnosa/datajson', 'DiagnosaController@datajson')->name('diagnosa.json')->middleware('auth');
...
Route::post('/diagnosa/print/', 'DiagnosaController@diagnosa_print')->name('diagnosa.print')->middleware('auth');
...
Route::post('/tindakan/import', 'TindakanController@import')->name('tindakan.import')->middleware('auth');

Route::get('/tindakan/export', 'TindakanController@export')->name('tindakan.export')->middleware('auth');

Route::get('/tindakan/cetak-pdf', 'TindakanController@cetak_pdf')->name('tindakan.cetakpdf')->middleware('auth');

Route::post('/tindakan/print/', 'TindakanController@tindakan_print')->name('tindakan.print')->middleware('auth');
...
Route::get('/pengaturan/add-to-log', 'PengaturanController@myTestAddToLog')->name('pengaturan.addtolog')->middleware('auth','admin');
Route::get('/pengaturan/logActivity', 'PengaturanController@logActivity')->name('pengaturan.logactivity')->middleware('auth','super_admin');
...
Route::post('/users/logout', 'UserController@logout')->name('logout')->middleware('auth');
...
Route::get('/recovery-mode', function () {
    \LogActivity::addToLog('Pengguna Mengunjungi Recovery Mode');
    return view('welcome');
    }
);
...
Route::get('cache', function () {
    ...
    Artisan::call('config:clear');
    Artisan::call('cache:clear');
    \LogActivity::addToLog('Pengguna Membersihkan Cache Website');
    return redirect()->back();
})->name('refresh-cache');